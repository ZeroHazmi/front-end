            ...
            <div className={user-signup-main-container}>
                <div className={user-signup-container}>
                    ...
                    <div className={user-signup-upper-form}>
                        ...
                        <div className={user-signup-or} style="width: 61px; left: 285px; top: 114px; position: absolute; text-align: center; color: black; font-size: 16px; font-weight: 500; word-wrap: break-word">
                            Or
                        </div>
                        ...
                        <div className={user-signup-icmissing-bg}>
                            ...
                            <label for="icmissing">
                                <button  className={user-signup-checkbox-button} type="button" onclick="document.getElementById('icmissing').checked = !document.getElementById('icmissing').checked;">
                                    IC only missing
                                </button>
                            </label>
